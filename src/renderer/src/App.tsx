...
import { CommandIcon, WandSparklesIcon, ClipboardCopyIcon, Settings2Icon } from 'lucide-react'
...
function App(): JSX.Element {
  ...
  return (
    <div className={`p-4 rounded flex gap-2 flex-col w-[500px] bg-background ${theme === 'dark' ? 'dark' : ''}`} style={{ fontSize: `${fontSize}px` }}>
      <div className="h-8 w-full flex items-center justify-between select-none mb-4">
        <span className="font-bold text-primary app-region-drag">Prompt Enhancer</span>
        <Button
      ...
      {showSettings ? (
        ...
        <div className="app-region-no-drag flex flex-col gap-2">
          <Textarea
            className="border border-gray-300 rounded p-2 app-region-no-drag max-h-[200px] text-xs"
