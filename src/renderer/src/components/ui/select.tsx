...
const SelectWithLabel = React.forwardRef<HTMLDivElement, SelectWithLabelProps>(
  ({ label, children, className, triggerClassName, ...props }, ref) => (
      ...
      <SelectPrimitive.Root {...props}>
        {React.Children.map(children, (child) => {
          if (
            ...
            child.type &&
            (child.type as typeof SelectTrigger).displayName === SelectTrigger.displayName
          ) {
            return React.cloneElement(child as React.ReactElement<{ className?: string }>, {
              className: cn((child.props as { className?: string }).className, triggerClassName)
            })
          }
          return child
        })}
